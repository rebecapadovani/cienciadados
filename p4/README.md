...
> 1. Flip horizontal: as inversões de imagem são realizadas ao longo de um eixo de simetria. Para aprimoramento de imagens médicas, elas podem ser realizadas tanto na vertical quanto na horizontal [2];
> 2. Flip Vertical;
...
> O principal desafio encontrado foi a compreensão de quais atributos foram relevantes para a classificação das imagens, tendo em vista que o aprendizado profundo estabelece esses atributos de forma a aplicar diversos filtros.

> Como trabalho futuro, ou com mais tempo para a entrega, surgiu o interesse de tentar explicar quais os atributos foram escolhidos pelos diversos filtros utilizados pelo modelo apresentado.
